CREATE TABLE IF NOT EXISTS tbCaseData
(
...
CREATE TABLE IF NOT EXISTS tbImportAcData 
(
	coId					bigint          identity,
...
CREATE TABLE IF NOT EXISTS tbImportLabsData
(
	coId					bigint          identity,
    coCaseId		    	bigint          null,
...
CREATE TABLE IF NOT EXISTS tbImportIcd10Data
(
	coId								bigint          identity,
    coCaseId		    				bigint          null,
...
CREATE TABLE IF NOT EXISTS tbImportDeviceMotionData
(
	coId							bigint          identity,
    coCaseId		    			bigint          null,
...
CREATE TABLE IF NOT EXISTS tbImportDevice1HzMotionData
(
	coId					bigint          identity,
    coCaseId		    	bigint          null,
	coTimestamp				datetime		null,
...
CREATE TABLE IF NOT EXISTS tbImportMedicationInpatientData
(
	coId					bigint          identity,
    coCaseId		    	bigint          null,
	coPatient_id			nvarchar(256)	null,
...
CREATE TABLE IF NOT EXISTS tbImportNursingDailyReportsData
(
	coId						bigint          identity,
    coCaseId		    		bigint          null,
	coPatient_id				nvarchar(256)	null,
